...
def jogo(quantidade_letras):
    ...
    tentativa = 1
    # Cria uma variável tentativa que inicia com 1, para contar quantas tentativas o jogador já fez
    ...
    while tentativa <= quantidade_letras:
        ...
        if palpite == palavra_secreta:
            ...
            break 
        # Se o palpite for igual a palavra secreta, o jogador ganhou e o jogo termina, o break serve para quebrar o loop do while

        resultado = ''
        # Cria uma variável resultado que inicia vazia, para armazenar o resultado do palpite do jogador
        ...
        print(f'A palavra contém as letras: {" ".join(letras_descobertas)}')
